...
> **Download the current Onyx build:** [latest macOS release](https://github.com/peteallen/onyx/releases/latest) · [universal DMG](https://github.com/peteallen/onyx/releases/download/v0.1.4/Onyx-0.1.4-macOS.dmg) · [SHA-256 checksum](https://github.com/peteallen/onyx/releases/download/v0.1.4/Onyx-0.1.4-macOS.dmg.sha256)
